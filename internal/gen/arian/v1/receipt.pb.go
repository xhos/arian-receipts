...
func (ReceiptStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_arian_v1_receipt_proto_enumTypes[0].Descriptor()
}

func (ReceiptStatus) Type() protoreflect.EnumType {
	return &file_arian_v1_receipt_proto_enumTypes[0]
}
...
func (ReceiptStatus) EnumDescriptor() ([]byte, []int) {
	return file_arian_v1_receipt_proto_rawDescGZIP(), []int{0}
}
...
func (x *ReceiptItem) Reset() {
	*x = ReceiptItem{}
	mi := &file_arian_v1_receipt_proto_msgTypes[0]
...
type Receipt struct {
	...
	Status              ReceiptStatus          `protobuf:"varint,12,opt,name=status,proto3,enum=arian.v1.ReceiptStatus" json:"status,omitempty"`
...
func (x *Receipt) Reset() {
	*x = Receipt{}
	mi := &file_arian_v1_receipt_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Receipt) Descriptor() ([]byte, []int) {
	return file_arian_v1_receipt_proto_rawDescGZIP(), []int{1}
}
...
func (x *ReceiptLinkCandidate) Reset() {
	*x = ReceiptLinkCandidate{}
	mi := &file_arian_v1_receipt_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReceiptLinkCandidate) Descriptor() ([]byte, []int) {
	return file_arian_v1_receipt_proto_rawDescGZIP(), []int{2}
}
...
var File_arian_v1_receipt_proto protoreflect.FileDescriptor

const file_arian_v1_receipt_proto_rawDesc = "" +
	"\n" +
	"\x16arian/v1/receipt.proto\x12\barian.v1\x1a\x17arian/v1/category.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x16google/type/date.proto\x1a\x17google/type/money.proto\"\xdf\x02\n" +
	...
	"\bcategory\x18\b \x01(\v2\x12.arian.v1.CategoryH\x02R\bcategory\x88\x01\x01\x12\x1d\n" +
	"\n" +
	...
	"\x06status\x18\f \x01(\x0e2\x17.arian.v1.ReceiptStatusR\x06status\x12+\n" +
	"\x05items\x18\r \x03(\v2\x15.arian.v1.ReceiptItemR\x05items\x129\n" +
	"\n" +
	...
	"\x15RECEIPT_STATUS_FAILED\x10\x04B\x8b\x01\n" +
	"\fcom.arian.v1B\fReceiptProtoP\x01Z,arian-receipts/internal/gen/arian/v1;arianv1\xa2\x02\x03AXX\xaa\x02\bArian.V1\xca\x02\bArian\\V1\xe2\x02\x14Arian\\V1\\GPBMetadata\xea\x02\tArian::V1b\x06proto3"

var (
	file_arian_v1_receipt_proto_rawDescOnce sync.Once
	file_arian_v1_receipt_proto_rawDescData []byte
)

func file_arian_v1_receipt_proto_rawDescGZIP() []byte {
	file_arian_v1_receipt_proto_rawDescOnce.Do(func() {
		file_arian_v1_receipt_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_arian_v1_receipt_proto_rawDesc), len(file_arian_v1_receipt_proto_rawDesc)))
	})
	return file_arian_v1_receipt_proto_rawDescData
}

var file_arian_v1_receipt_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_arian_v1_receipt_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_arian_v1_receipt_proto_goTypes = []any{
	(ReceiptStatus)(0),            // 0: arian.v1.ReceiptStatus
	(*ReceiptItem)(nil),           // 1: arian.v1.ReceiptItem
	(*Receipt)(nil),               // 2: arian.v1.Receipt
	(*ReceiptLinkCandidate)(nil),  // 3: arian.v1.ReceiptLinkCandidate
	(*money.Money)(nil),           // 4: google.type.Money
	(*Category)(nil),              // 5: arian.v1.Category
	(*date.Date)(nil),             // 6: google.type.Date
	(*timestamppb.Timestamp)(nil), // 7: google.protobuf.Timestamp
}
var file_arian_v1_receipt_proto_depIdxs = []int32{
	4,  // 0: arian.v1.ReceiptItem.unit_price:type_name -> google.type.Money
	5,  // 1: arian.v1.ReceiptItem.category:type_name -> arian.v1.Category
	6,  // 2: arian.v1.Receipt.receipt_date:type_name -> google.type.Date
	4,  // 3: arian.v1.Receipt.subtotal:type_name -> google.type.Money
	4,  // 4: arian.v1.Receipt.tax:type_name -> google.type.Money
	4,  // 5: arian.v1.Receipt.total:type_name -> google.type.Money
	0,  // 6: arian.v1.Receipt.status:type_name -> arian.v1.ReceiptStatus
	1,  // 7: arian.v1.Receipt.items:type_name -> arian.v1.ReceiptItem
	7,  // 8: arian.v1.Receipt.created_at:type_name -> google.protobuf.Timestamp
	7,  // 9: arian.v1.Receipt.updated_at:type_name -> google.protobuf.Timestamp
	4,  // 10: arian.v1.Receipt.transaction_amount:type_name -> google.type.Money
	4,  // 11: arian.v1.ReceiptLinkCandidate.amount:type_name -> google.type.Money
	7,  // 12: arian.v1.ReceiptLinkCandidate.tx_date:type_name -> google.protobuf.Timestamp
...
func init() { file_arian_v1_receipt_proto_init() }
func file_arian_v1_receipt_proto_init() {
	if File_arian_v1_receipt_proto != nil {
		return
	}
	file_arian_v1_category_proto_init()
	file_arian_v1_receipt_proto_msgTypes[0].OneofWrappers = []any{}
	file_arian_v1_receipt_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_arian_v1_receipt_proto_rawDesc), len(file_arian_v1_receipt_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_arian_v1_receipt_proto_goTypes,
		DependencyIndexes: file_arian_v1_receipt_proto_depIdxs,
		EnumInfos:         file_arian_v1_receipt_proto_enumTypes,
		MessageInfos:      file_arian_v1_receipt_proto_msgTypes,
	}.Build()
	File_arian_v1_receipt_proto = out.File
	file_arian_v1_receipt_proto_goTypes = nil
	file_arian_v1_receipt_proto_depIdxs = nil
}
