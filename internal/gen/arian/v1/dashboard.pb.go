...
const file_arian_v1_dashboard_proto_rawDesc = "" +
	...
	"\rNetWorthPoint\x12%\n" +
	"\x04date\x18\x01 \x01(\v2\x11.google.type.DateR\x04date\x12/\n" +
	"\tnet_worth\x18\x02 \x01(\v2\x12.google.type.MoneyR\bnetWorthB\x8d\x01\n" +
	"\fcom.arian.v1B\x0eDashboardProtoP\x01Z,arian-receipts/internal/gen/arian/v1;arianv1\xa2\x02\x03AXX\xaa\x02\bArian.V1\xca\x02\bArian\\V1\xe2\x02\x14Arian\\V1\\GPBMetadata\xea\x02\tArian::V1b\x06proto3"
